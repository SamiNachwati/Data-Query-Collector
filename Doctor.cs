 ...
 *  Purpose: Class used to create instances of Doctor objects when DOCTOR information is retrieved from the database
 */
namespace DatabaseForm
{
    /// <summary>
    /// Class used to retrieve information stemming from the DOCTOR table
    /// </summary>
